...
class LoraModel(BaseTuner):
    ...
    **Attributes**:
    ...
    def __init__(self, model, config, adapter_name) -> None:
        # print(f'{config=}',' line 111 in model.py')
    ...
    def _create_and_replace(
        ...
        kwargs = {
            ...
            "spectral_top": lora_config.spectral_top,
            "spectral_bottom": lora_config.spectral_bottom,
            "spectral_twenty": lora_config.spectral_twenty
        }
        ...
        if isinstance(target, LoraLayer) and not isinstance(target, AdaLoraLayer):
            ...
            # print(f'{kwargs=}',' line 183 in model.py')
