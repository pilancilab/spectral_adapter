...
def convert_edlora(pipe, state_dict, enable_edlora, alpha=0.6):
    ...
    updated_unet_state_dict = merge_spectraloft_into_weight(pretrained_unet_state_dict, unet_lora_state_dict, model_type='unet', alpha=alpha, idx=0,top=True)
    ...
    updated_text_encoder_state_dict = merge_spectraloft_into_weight(pretrained_text_encoder_state_dict, text_encoder_lora_state_dict, model_type='text_encoder', alpha=alpha, idx=0,top=True)
