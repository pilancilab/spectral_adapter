...
from mixofshow.models.edlora import (SVDiffLinearLayer, revise_edlora_unet_attention_controller_forward, revise_edlora_unet_attention_forward)
                ...
                if module.__class__.__name__ == where:
                    for child_name, child_module in module.named_modules():
                        if child_module.__class__.__name__ == 'Linear':
                            lora_module = SVDiffLinearLayer(name + '.' + child_name, child_module, **text_encoder_cfg['lora_cfg'])
                ...
                if module.__class__.__name__ == where:
                    for child_name, child_module in module.named_modules():
                        if child_module.__class__.__name__ == 'Linear' or (child_module.__class__.__name__ == 'Conv2d' and child_module.kernel_size == (1, 1)):
                            lora_module = SVDiffLinearLayer(name + '.' + child_name, child_module, **unet_cfg['lora_cfg'])
