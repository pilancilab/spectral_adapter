...
from .tuners.lora.layer import Linear as loralinear
from .utils import (
    ...
    def forward(
        ...
        **kwargs,
        ...
        if not peft_config.is_prompt_learning:
            ...
            #         print(f'before: {hasattr(m, "U")=}')
            #         print(f'before: {hasattr(m, "aaa")=}')
            #         # m.aaa = 5
            #         break
            ...
            # for n,m in self.base_model.named_modules():
            #     if isinstance(m,loralinear):
            #         print(f'after: {hasattr(m, "U")=}')
            #         print(f'after: {hasattr(m, "aaa")=}')
            #         break
